...
const s = StyleSheet.create({
  ...
  imgCounterTxt: { fontFamily: 'Almarai_700Bold',  color: '#fff', fontSize: 13, paddingTop: 2 },
  ...
  headerArea: { gap: 12 },
  title: { fontFamily: 'Almarai_800ExtraBold',  fontSize: 24, color: '#0f172a', writingDirection: 'rtl', lineHeight: 34 },
  ...
  priceSub: { fontFamily: 'Almarai_400Regular',  fontSize: 13, color: '#64748b' },
  iconBgWrap: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#EFF6FF', alignItems: 'center', justifyContent: 'center' },

  section: { gap: 16 },
  sectionTitle: { fontFamily: 'Almarai_800ExtraBold',  fontSize: 18, color: '#0f172a', writingDirection: 'rtl' },
  ...
  specVal: { fontFamily: 'Almarai_800ExtraBold',  fontSize: 12, color: '#0f172a', textAlign: 'center' },
  specLbl: { fontFamily: 'Almarai_400Regular',  fontSize: 10, color: '#64748b', textAlign: 'center' },
  ...
  desc: { fontFamily: 'Almarai_400Regular',  fontSize: 14, color: '#334155', writingDirection: 'rtl', lineHeight: 26 },
  ...
  sellerName: { fontFamily: 'Almarai_800ExtraBold',  fontSize: 16, color: '#0f172a', writingDirection: 'rtl' },
  sellerGov: { fontFamily: 'Almarai_400Regular',  fontSize: 13, color: '#64748b', writingDirection: 'rtl', textAlign: 'right' },
  ...
  callWideTxt: { fontFamily: 'Almarai_800ExtraBold',  color: Colors.primary, fontSize: 16 },
  // Location & Map
