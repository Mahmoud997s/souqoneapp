...
const s = StyleSheet.create({
  ...
  title: { fontFamily: 'Almarai_700Bold', paddingTop: 4, paddingBottom: 4, includeFontPadding: false, fontSize: 24, color: Colors.primary, marginBottom: 8, writingDirection: 'rtl' },
  subtitle: { fontFamily: 'Almarai_400Regular', paddingTop: 4, paddingBottom: 4, includeFontPadding: false, fontSize: 14, color: Colors.text2, textAlign: 'center', writingDirection: 'rtl' },
  ...
  badgeTxt: { fontFamily: 'Almarai_700Bold', paddingTop: 4, paddingBottom: 4, includeFontPadding: false, fontSize: 12, color: Colors.white },
  cardHeader: { alignItems: 'center', marginBottom: Spacing.space4 },
  titleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center' },
  cardTitle: { fontFamily: 'Almarai_700Bold', paddingTop: 4, paddingBottom: 4, includeFontPadding: false, fontSize: 20 },
  price: { fontFamily: 'Almarai_800ExtraBold', paddingTop: 4, paddingBottom: 4, includeFontPadding: false, fontSize: 28, marginTop: 4 },
  ...
  featureTxt: { flex: 1, fontFamily: 'Almarai_400Regular', paddingTop: 4, paddingBottom: 4, includeFontPadding: false, fontSize: 14, writingDirection: 'rtl' },
  btn: { paddingVertical: 12, borderRadius: Radius.lg, alignItems: 'center' },
  btnTxt: { fontFamily: 'Almarai_700Bold', paddingTop: 4, paddingBottom: 4, includeFontPadding: false, fontSize: 16 }
})
