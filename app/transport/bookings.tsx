...
const s = StyleSheet.create({
  ...
  roleText: { fontFamily: 'Almarai_700Bold',  fontSize: 13, color: Colors.text2 },
  ...
  bookingDate: { fontFamily: 'Almarai_400Regular',  fontSize: 11, color: Colors.textMuted, marginTop: 2 },
  ...
  routeText: { fontFamily: 'Almarai_700Bold',  fontSize: 12, color: Colors.text },
  ...
  startBtnText: { fontFamily: 'Almarai_700Bold',  fontSize: 12, color: '#fff' },
  ...
  completeBtnText: { fontFamily: 'Almarai_700Bold',  fontSize: 12, color: '#fff' },
