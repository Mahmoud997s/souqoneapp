...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: 'Almarai_700Bold',  fontSize: 18, color: '#111827' },
})

const s = StyleSheet.create({
  label: { fontFamily: 'Almarai_700Bold',  fontSize: 16, color: Colors.text, writingDirection: 'rtl', marginBottom: 12, marginTop: 24 },
  ...
  dash: { fontFamily: 'Almarai_700Bold',  fontSize: 20, color: Colors.textMuted },
  ...
  chipTxt: { fontFamily: 'Almarai_400Regular',  fontSize: 14, color: Colors.text2 },
  chipTxtActive: { fontFamily: 'Almarai_700Bold',  color: Colors.primary },
  ...
  resetTxt: { fontFamily: 'Almarai_700Bold',  fontSize: 16, color: Colors.text2 },
  applyBtn: { flex: 2, height: 56, alignItems: 'center', justifyContent: 'center', borderRadius: Radius.lg, backgroundColor: Colors.primary },
  applyTxt: { fontFamily: 'Almarai_700Bold',  fontSize: 16, color: Colors.white },
})
