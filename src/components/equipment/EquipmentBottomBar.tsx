...
const TABS = [
  { id: 'home', label: 'الرئيسية', icon: 'home', iconO: 'home-outline' },
...
export const EquipmentBottomBar = () => {
  ...
  const handlePost = () => {
    ...
    // Set category to equipment and redirect to the unified post workflow
            ...
            <Pressable 
              ...
              onPress={() => {
                ...
                if (tab.id === 'home') {
                  ...
                  // Navigate to favorites with equipment tab selected
                  router.push('/profile/favorites?tab=معدات' as any)
            ...
            >
              <View style={s.iconContainer}>
                ...
                <Ionicons 
                  ...
                  size={24} 
                  color={isActive ? '#d97706' : Colors.textMuted} 
                />
              </View>
...
const s = StyleSheet.create({
  ...
  iconBg: {
    ...
    height: 30,
    borderRadius: 15,
    backgroundColor: '#d977061A', // Amber light bg
  },
  label: {
