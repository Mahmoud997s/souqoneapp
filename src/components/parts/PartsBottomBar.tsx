...
const TABS = [
  { id: 'home', label: 'الرئيسية', icon: 'construct', iconO: 'construct-outline' },
...
export const PartsBottomBar = () => {
  ...
  const handlePost = () => {
    ...
    // Set category to parts and redirect to unified post workflow step 2
    set({ category: 'parts' })
            ...
            <Pressable 
              ...
              onPress={() => {
                ...
                if (tab.id === 'home') {
                  ...
                  router.push('/profile/favorites?tab=قطع غيار' as any)
