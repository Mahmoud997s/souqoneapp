...
import { PartStep2Props } from '../../../types/partForm.types'
import { MAX_PART_IMAGES } from '../../../constants/parts'

export function PartStep2Images({
  images,
  existingImages,
  errors,
  isUploading,
  ...
  return (
    <View style={s.stepWrap}>
      ...
      <TouchableOpacity
        ...
        disabled={isUploading || totalCount >= MAX_PART_IMAGES}
        activeOpacity={0.8}
      >
        {isUploading ? (
          ...
          <View style={s.uploadContent}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={s.uploadBoxTxt}>إرفاق صور واضحة للقطعة</Text>
              <Text style={s.uploadBoxSub}>
                {totalCount > 0
                  ? `تم اختيار ${totalCount} من ${MAX_PART_IMAGES} صور مسموحة`
                  : `الصور اختيارية – يمكنك اختيار حتى ${MAX_PART_IMAGES} صور (الصورة الأولى ستكون الرئيسية)`}
              </Text>
            </View>
