...
interface MyListingsNavBarProps {
  paddingTop: number
  onBackPress: () => void
}

export function MyListingsNavBar({ paddingTop, onBackPress }: MyListingsNavBarProps) {
  return (
    <View style={[s.navBarFixed, { paddingTop }]}>
      <View style={s.navBarRow}>
        ...
        <View style={s.navTitleBadge}>
          <Text style={s.navTitle} numberOfLines={1}>إعلاناتي</Text>
        </View>
